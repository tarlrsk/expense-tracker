...
---
Answer the question (from `$ARGUMENTS` or the conversation) using only `../expense-tracker-spec` (docs, plans, decisions, journal), plus `git log` of both repos for exact file changes and commits.
